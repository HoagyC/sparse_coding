...
def main(device: str) -> None:
    ...
    for layer in layers:
        ...
        for ratio_str in ratio_strs:
            ...
            transform_ndxs, transform_scores = read_transform_scores(results_loc, score_mode="top_random")

            times_active, means, vars, skews, kurtoses = calc_moments_streaming(chosen_dict, chunk, batch_size=1000)
