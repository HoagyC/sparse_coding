...
layer_filenames = [
    f"/mnt/ssd-cluster/bigrun0308/output_hoagy_dense_sweep_tied_resid_l{layer}_r4/_9/learned_dicts.pt"
...
for layer, (best_idx, scores) in enumerate(all_scores):
    plt.scatter([score[1] for score in scores], [score[2] for score in scores], label=f"Layer {layer}", color=colors[layer])
