...
class Adam:
    ...
    def update(self, grads, states):
        ...
        corrected_first_moments = optree.tree_map(lambda m: m / bias_correction_0, updated_first_moments)
        corrected_second_moments = optree.tree_map(lambda v: v / bias_correction_1, updated_second_moments)
        ...
        return updates, {
            "first_moments": updated_first_moments,
            "second_moments": updated_second_moments,
            "step": step,
        }
